<ul class="event-calendar-quick-nav">
  <li><a href="$Link(today)"<% if CurrentActionIs(today) %> class="current"<% end_if %>><% _t('Calendar.QUICKNAVTODAY','Today') %></a></li>
  <li><a href="$Link(week)"<% if CurrentActionIs(week) %> class="current"<% end_if %>><% _t('Calendar.QUICKNAVWEEK','This week') %></a></li>
  <li><a href="$Link(month)"<% if CurrentActionIs(month) %> class="current"<% end_if %>><% _t('Calendar.QUICKNAVMONTH','This month') %></a></li>
  <li><a href="$Link(weekend)"<% if CurrentActionIs(weekend) %> class="current"<% end_if %>><% _t('Calendar.QUICKNAVWEEKEND','This weekend') %></a></li>
</ul>
